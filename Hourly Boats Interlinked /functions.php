...
function localize_blocked_dates_for_calendar() {
    // Only proceed if the script is already enqueued
    if (wp_script_is('booking-calendar', 'enqueued')) {
        ...
        wp_localize_script('booking-calendar', 'boatRentalBlockedDates', array(
            'drop_off' => $drop_off,
            'hourly' => $hourly,
        ));
    }
}
add_action('wp_enqueue_scripts', 'localize_blocked_dates_for_calendar', 20);
        ...
        while (have_rows('boat_time_slots', $boat_id)) {
            ...
            $booking_query = new WP_Query(array(
                ...
                'meta_query' => array(
                    ...
                    array('key' => 'booking_hours', 'value' => get_the_title($boat_hours), 'compare' => '='),
...
function save_booking_after_submission($entry, $form) {
    ...
    $existing_booking = new WP_Query(array(
        ...
        'meta_query' => array(
            ...
            array('key' => 'booking_hours', 'value' => $boat_hours, 'compare' => '='),
    ...
    update_field('booking_hours', $boat_hours, $booking_id);
